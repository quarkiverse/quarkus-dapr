...
a|icon:lock[title=Fixed at build time] [[quarkus-dapr_quarkus-dapr-devservices-shared]] [.property-path]##link:#quarkus-dapr_quarkus-dapr-devservices-shared[`quarkus.dapr.devservices.shared`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.dapr.devservices.shared+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_DAPR_DEVSERVICES_SHARED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_DAPR_DEVSERVICES_SHARED+++`
endif::add-copy-button-to-env-var[]
--
|boolean
|`+++true+++`

a|icon:lock[title=Fixed at build time] [[quarkus-dapr_quarkus-dapr-devservices-service-name]] [.property-path]##link:#quarkus-dapr_quarkus-dapr-devservices-service-name[`quarkus.dapr.devservices.service-name`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.dapr.devservices.service-name+++[]
endif::add-copy-button-to-config-props[]


[.description]
--
The value of the `quarkus-dev-service-dapr` label attached to the started container.

This is used to discover and re-use an existing shared Dapr container.


ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_DAPR_DEVSERVICES_SERVICE_NAME+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
Environment variable: `+++QUARKUS_DAPR_DEVSERVICES_SERVICE_NAME+++`
endif::add-copy-button-to-env-var[]
--
|string
|`+++dapr+++`

a|icon:lock[title=Fixed at build time] [[quarkus-dapr_quarkus-dapr-devservices-dashboard-enabled]] [.property-path]##link:#quarkus-dapr_quarkus-dapr-devservices-dashboard-enabled[`quarkus.dapr.devservices.dashboard.enabled`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.dapr.devservices.dashboard.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_DAPR_DEVSERVICES_DASHBOARD_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
...
a|icon:lock[title=Fixed at build time] [[quarkus-dapr_quarkus-dapr-workflow-enabled]] [.property-path]##link:#quarkus-dapr_quarkus-dapr-workflow-enabled[`quarkus.dapr.workflow.enabled`]##
ifdef::add-copy-button-to-config-props[]
config_property_copy_button:+++quarkus.dapr.workflow.enabled+++[]
endif::add-copy-button-to-config-props[]
...
ifdef::add-copy-button-to-env-var[]
Environment variable: env_var_with_copy_button:+++QUARKUS_DAPR_WORKFLOW_ENABLED+++[]
endif::add-copy-button-to-env-var[]
ifndef::add-copy-button-to-env-var[]
