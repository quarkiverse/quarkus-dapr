...
[NOTE]
====
If you declare a `state.postgresql` component and the Dapr Dashboard is enabled, Dev Services will not start its own PostgreSQL container: the Dapr sidecar and the Dashboard use your component instead.
====
