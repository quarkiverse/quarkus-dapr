...
import io.quarkiverse.dapr.workflows.rest.CreateUserWorkflow;
...
public class WorkflowsResource {
    ...
    public Response createUser(CreateUserRequest createUserRequest) {
        ...
        String instanceId = daprWorkflowClient.scheduleNewWorkflow(CreateUserWorkflow.class, createUserRequest);
        return Response.accepted()
                .header("X-Instance-Id", instanceId)
                .build();
    }
